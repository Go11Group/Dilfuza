...
func (db *UserRepo) GetAllUsers(name string) (*[]models.User, error) { // GetAllUsers barcha foydalanuvchilarni olish uchun funksiya, ism bo'yicha filtrlash mumkin.
	resp := []models.User{}
...
func (db *UserRepo) Search(email string) (*[]models.User, error) { // Search email bo'yicha foydalanuvchilarni qidiruv uchun funksiya
...
func (db *UserRepo) UpdatePassword(id string, newPassword string) error { // UpdatePassword foydalanuvchi parolini yangilash uchun funksiya.
